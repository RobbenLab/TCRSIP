...
# if [ "$simulate" -eq 1] ; then
    ...
    gmx grompp -f ../../Settings/md-unfolding-charmm.mdp -c npt.gro -r npt.gro -t npt.cpt -p topol.top -o md.tpr
...
# if  [ "$analyze" -eq 1] ; then
    ...
    printf "1\n0\n" | gmx trjconv -s md.tpr -f md.xtc -o md_center.xtc -center -pbc nojump #mol #Output 0 is second option for whole system in centered trajectory
